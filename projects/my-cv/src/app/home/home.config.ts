...
import {
  IconType,
  Skills
} from "./../../../../../my-libs/gav-gear-list-display/gav-gear-list-display.model";
...
export const skillList: Skills = new Skills([
  {
    skill: "Angular",
    rating: 7,
    description: `I've been working in Angular for about a year now. S.O.L.I.D. principles, lazy loading, OnPush Strategy, etc.
            I have also been developing my ability to extend basic classes (such as the Validators class), etc.
  ...
  },
  {
    ...
    description: `Great practice with Typescript. Wide usage of types, interfaces, classes and services.
            Also like thinking on puzzles, with personal developing alternatives such as an account on codewars and such.
            Concatenation of methods, destructuring, spread, rest, DRY principle, etc. JS Styling Guide by AirBNB`,
    icon: "keyboard"
  },
  {
    skill: "HTML",
  ...
  },
  {
    ...
    description: `Nesting is used, but not overused. Classes go to the point.
            ...
            Lots of responsiveness in general. Not putting a 10 because there's a lot more to learn on CSS.
